...
//没有显式调用VertexSE3数据类型，而是直接load g2o文件，需要使用这个宏函数。
...
*/   
    // 使用Cholmod中的线性方程求解器
        ...
        // L-M 下降
        g2o::OptimizationAlgorithmLevenberg* optimizationAlgorithm= new g2o::OptimizationAlgorithmLevenberg( block_solver );
